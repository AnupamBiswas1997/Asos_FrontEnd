...
import logoAsos1 from "../assets/logoAsos1.PNG";
...
export function Navbar() {
  ...
  const fetchCartData = async () => {
    ...
    if (userEmail) {
      try {
        setLoadingCart(true);
        const response = await axios.get(`https://asos-backend-clone.onrender.com/cart/${userEmail}`);
      ...
      <div id="Nav4thSeg">
        ...
        <div className="icon cartIcon" onClick={handleCartClick}>
          ...
          <div className="CartOverlay">
            {loadingCart ? (
              <div className="loadingCart">Loading cart...</div>
            ) : cartItems.length > 0 ? (
